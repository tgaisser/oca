...
import {PreRegistrationLandingPageContentsComponent} from './pre-registration-landing-page-contents.component';
import {CUSTOM_ELEMENTS_SCHEMA} from '@angular/core';
import {selectLandingPageAccountCreationForm} from '../../state/enrollment/selectors';
import {lastValueFrom} from 'rxjs';


describe('PreRegistrationLandingPageComponent', () => {
	let component: PreRegistrationLandingPageContentsComponent;
	let fixture: ComponentFixture<PreRegistrationLandingPageContentsComponent>;
	...
	beforeEach(waitForAsync(() => {
		return TestBed.configureTestingModule({
			declarations: [PreRegistrationLandingPageContentsComponent],
			imports: [
				CustomMocksModule,
				FormsModule,
				ReactiveFormsModule,
	...
	beforeEach(() => {
		fixture = TestBed.createComponent(PreRegistrationLandingPageContentsComponent);
