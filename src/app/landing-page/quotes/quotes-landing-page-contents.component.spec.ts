...
import {QuotesLandingPageContentsComponent} from './quotes-landing-page-contents.component';
import {CUSTOM_ELEMENTS_SCHEMA} from '@angular/core';
import { selectLandingPageAccountCreationForm } from '../../state/enrollment/selectors';
import { lastValueFrom } from 'rxjs';


describe('QuotesLandingPageContentsComponent', () => {
	let component: QuotesLandingPageContentsComponent;
	let fixture: ComponentFixture<QuotesLandingPageContentsComponent>;
	...
	beforeEach(waitForAsync(() => {
		return TestBed.configureTestingModule({
			declarations: [QuotesLandingPageContentsComponent],
			imports: [
				CustomMocksModule,
				FormsModule,
				ReactiveFormsModule,
	...
	beforeEach(() => {
		fixture = TestBed.createComponent(QuotesLandingPageContentsComponent);
